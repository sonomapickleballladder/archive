const ladderSeason = '_Winter_2025';
...
const thisLadder = 'Womens';
const laddersOffered = {'Open': {ls: '_44854224859696286340_', min: 0, sb: '', url: './'}, 'Womens': {ls: '_58342948998688589488_', min: 0, url: '@Womens/', sb: 'womens-ladder_'}}
