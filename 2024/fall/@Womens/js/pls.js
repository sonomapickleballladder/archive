...
function signupReminder() {
    ...
    let swa = (document.referrer.indexOf('../signup_form')>-1 || localStorage.getItem(brick('$_hasRegistered'+ladderSeason)) || lsdciph(localStorage.getItem(brick('$_authenticated_user'+ladderSeason)),0,laddersOffered.Open.ls))
    console.log(swa);
    if(swa) {return false}
